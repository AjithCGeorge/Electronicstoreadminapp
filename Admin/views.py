...
# from .user_creation import createorders
...
def adminhome(request):
    ...
    print(sum)
    return render(request, 'adminHome.html', {'pending': len(pending),'orders':len(orders),'sellers':len(sellers),'customers':len(customers),
                                              'sales':sum})
